<%@ Page Title="" Language="C#" MasterPageFile="~/Shop.Master" AutoEventWireup="true" CodeBehind="payment.aspx.cs" Inherits="Shop.payment" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MenuContent" runat="server">
    ...
    <li><a href="/payment.aspx" class="current"><span>Оплата и доставка</span></a></li>

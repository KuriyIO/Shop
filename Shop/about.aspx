<%@ Page Title="" Language="C#" MasterPageFile="~/Shop.Master" AutoEventWireup="true" CodeBehind="about.aspx.cs" Inherits="Shop.about" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MenuContent" runat="server">

    <li><a href="/home.aspx"><span>Главная</span></a></li>
	<li><a href="/catalog.aspx"><span>Каталог товаров</span></a></li>
	<li><a href="/about.aspx" class="current"><span>О Нас</span></a></li>
